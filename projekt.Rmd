...
```{r histogram1, fig.align='center', fig.cap='Histogram kmetijskih kultur v Sloveniji'}
...
```{r histogram2, fig.align='center', fig.cap='Histogram živine v Sloveniji'}
...
```{r zemljevid1, fig.align='center', fig.cap='Zemljevid povprečne razširjenosti kmetijskih izdelkov po regijah'}
...
```{r zemljevid2, fig.align='center', fig.cap='Zemljevid povprečne razširjenosti živinorejskih izdelkov po regijah'}
